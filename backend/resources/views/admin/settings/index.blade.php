                ...
                <div class="settings-card">
                    ...
                    <div class="settings-form">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-input" value="SkillsXchange" placeholder="Enter site name">
                        </div>
                        <div class="form-group">
                            <label class="form-label">Site Description</label>
                            <textarea class="form-textarea" placeholder="Enter site description">A platform for skill exchange and learning</textarea>
                        </div>
                        <div class="form-group">

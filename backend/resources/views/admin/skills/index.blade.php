            ...
            <div class="add-skill-card">
                ...
                <form method="POST" action="{{ route('admin.skill.store') }}" class="add-skill-form">
                    ...
                    <div class="form-group">
                        ...
                        <input id="name" name="name" type="text" value="{{ old('name') }}" required class="form-input" placeholder="e.g., Web Development" />
                        @error('name')
                    ...
                    <div class="form-group">
                        ...
                        <input id="category" name="category" type="text" value="{{ old('category') }}" required class="form-input" placeholder="e.g., IT" />
                        @error('category')
                            <div class="error-text">{{ $message }}</div>
                        @enderror
                    </div>
